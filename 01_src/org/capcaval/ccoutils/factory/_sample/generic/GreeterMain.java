...
public class GreeterMain {
	...
	public static void main(String[] args) {
		...
		// Generic factory can also be used to create instance with parameters
		// it only need having constructor with the same parameters
		g = Greeter.factory.newInstance(" !!!!");
		System.out.println(g.sayHello("world"));
