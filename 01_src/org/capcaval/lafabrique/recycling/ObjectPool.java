package org.capcaval.lafabrique.recycling;
...
public class ObjectPool <T>{
	...
	public T newInstance(Class<T> poolType){
		...
		try {
			...
			throw new RuntimeException("[laFabrique] Error : The class " + poolType + " can not instanciate. Check that it has a default constructor without paramaeter.", e);
		}
		return obj;
	}
